...
export default class OrderItemSheet extends ItemSheet {
  ...
  getData() {
    ...
    perkBonusTargets.push(
      ...
      { value: "DurabilityThresholdMax", label: "Макс. порог прочности" },
      { value: "DurabilityReserveMax", label: "Макс. запас прочности" },
      { value: "OptionalModulesMax", label: "Макс. опциональные модули" },
